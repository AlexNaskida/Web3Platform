  ...
  return (
    <div className="flex flex-row w-full justify-between">
      ...
      <div className="flex flex-row w-2/5 justify-end gap-5">
        <div className="flex flex-row gap-4 justify-start items-center px-4 w-1/2 bg-secondary rounded-full">
          <Search size={25} className="text-primary" />
          <p className="text-lg text-muted-foreground">Search...</p>
        </div>
        <div className="flex items-center justify-center size-12 bg-secondary p-1 border-3 border-primary rounded-full">
